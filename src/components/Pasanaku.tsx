            ...
            <div className="bg-gradient-to-br from-white/20 to-[#7AB82E]/20 dark:from-[#0D5269]/80 dark:to-[#083D52]/80 shadow-2xl p-6 md:p-8 rounded-2xl border border-white/30 dark:border-[#0D5269]/40 backdrop-blur-sm">
                ...
                <div className="space-y-6">
                    <div>
                        ...
                        <input className="w-full h-2 bg-white/30 dark:bg-[#062D3D] rounded-lg appearance-none cursor-pointer accent-white dark:accent-[#7AFF6C]" max="30" min="5" type="range" value={persons} onChange={(e) => setPersons(+e.target.value)} />
                    </div>
                    <div>
                        <div className="flex justify-between mb-2">
                        ...
                        <input className="w-full h-2 bg-white/30 dark:bg-[#062D3D] rounded-lg appearance-none cursor-pointer accent-white dark:accent-[#7AFF6C]" max="5000" min="50" step="1" type="range" value={amount} onChange={handleChangeAmount} />
                    </div>
